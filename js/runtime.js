...
function tt(
  ...
  return async function (r, o) {
    ...
    if (
      (a.path && !Qe.test(a.path) && (a.path += ".js"),
      a.path && a.version && Xe.test(a.version))
    )
    ...
    return `${e}${i.name}@${i.version}/${
      ...
      (function (e) {
        for (const n of t) {
          ...
          if ("string" == typeof t)
            return (
              t.startsWith("./") && (t = t.slice(2)), Qe.test(t) ? t : `${t}.js`
            );
        }
      })(i) ||
      "index.js"
...
function rt(e) {
  ...
  function a(e) {
    return arguments.length > 1
      ? Promise.all(Ye.call(arguments, n)).then(ot)
      : n(e);
  }
  return (
    (a.alias = function (t) {
...
function ot(e) {
  ...
  for (const n of e)
    for (const e in n)
      Je.call(n, e) &&
        (null == n[e]
          ? Object.defineProperty(t, e, { get: at(n, e) })
          : (t[e] = n[e]));
  return t;
}
function at(e, t) {
  ...
  r < 2
    ...
    Ve.push(
      Ze.call(t, it)
        ...
        : (e) =>
            Promise.all(Ye.call(t, e)).then((e) =>
...
var At = Object.freeze({
  ...
  element: function (e, t) {
    ...
    var a = Ct.hasOwnProperty(r)
      ? document.createElementNS(Ct[r], e)
  ...
  try {
    switch (n.mimeType) {
      ...
      case "text/tab-separated-values":
        return await a.insertCSVFromPath(n.name, {
          name: t,
          schema: "main",
          ...r,
        });
      ...
      if ((r = arguments[s]) instanceof Node)
        ...
        for (l = 0, u = r.length; l < u; ++l)
          (o = r[l]) instanceof Node
            ? (null === p &&
                ((d[++h] = p = document.createDocumentFragment()),
                (f += "\x3c!--o:" + h + "--\x3e")),
              p.appendChild(o))
            : ((p = null), (f += o));
        p = null;
      ...
      return pn(
        ...
        (function (e, t) {
          ...
          const c = [
            [
              `SELECT ${
                r.columns ? r.columns.map(n).join(", ") : "*"
              } FROM ${hn(o.table, n)}`,
            ],
          ];
          ...
          if ("mssql" === t.dialect) {
            if (null !== s.to || null !== s.from) {
              if (!i.length) {
                ...
                mn("\nORDER BY ", c),
                  bn({ column: r.columns[0], direction: "ASC" }, c, n);
              }
...
function vn({ type: e, operands: t }, n, r) {
  ...
  if (2 !== t.length || ["in", "nin"].includes(e)) {
    ...
    !(function (e, t) {
      let n = !0;
      for (const r of e)
        n ? (n = !1) : mn(",", t), t.push(r.value), t[0].push("");
    })(t.slice(1), n),
      mn(")", n);
  } else {
    if (["c", "nc"].includes(e)) {
        ...
        ((n = {
          ...
          tex: () =>
            (function (e) {
              return Promise.all([
                e($e.resolve()),
                e.resolve($e.resolve("dist/katex.min.css")).then(Xt),
              ]).then(function (e) {
                var t = e[0],
                  n = r();
                function r(e) {
                  return function () {
                    ...
                    return (
                      t.render(Kt.apply(String, arguments), n, e),
          ...
          Inputs: () =>
            t(Ne.resolve()).then((e) => ({ ...e, file: e.fileOf(gt) })),
          L: () =>
            (async function (e) {
    ...
    value: function (e) {
      ...
      if (!n)
        if (((n = new Variable(2, this)), this._builtins.has(e)))
          n.define(e, _n(this._builtins.get(e)));
  ...
  _computeNow: {
    value: async function () {
      ...
      do {
        ...
        e.forEach(function (t) {
          Pn(t) &&
            (Wn(t, new RuntimeError("circular definition")),
            t._outputs.forEach(Un),
            e.delete(t));
        });
      } while (e.size);
      function o(e) {
